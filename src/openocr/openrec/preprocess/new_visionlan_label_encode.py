...
class NewVisionLANLabelEncode(BaseRecLabelEncode):
    ...
    def __call__(self, data):
        ...
        # Avoid noisy warning for naturally empty residual text
        # (e.g., one-character labels).
        if len(label_res) > 0:
