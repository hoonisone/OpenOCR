...
DATASET_MODULES = {
    'SimpleDataSet': 'openocr.tools.data.simple_dataset',
    'LMDBDataSet': 'openocr.tools.data.lmdb_dataset',
    'TextLMDBDataSet': 'openocr.tools.data.text_lmdb_dataset',
    'MultiScaleDataSet': 'openocr.tools.data.simple_dataset',
    'STRLMDBDataSet': 'openocr.tools.data.strlmdb_dataset',
    'LMDBDataSetTest': 'openocr.tools.data.lmdb_dataset_test',
    'RatioDataSet': 'openocr.tools.data.ratio_dataset',
    'RatioDataSetTest': 'openocr.tools.data.ratio_dataset_test',
    'RatioDataSetTVResize': 'openocr.tools.data.ratio_dataset_tvresize',
    'RatioDataSetTVResizeTest': 'openocr.tools.data.ratio_dataset_tvresize_test',
    'NaSizeDataSet': 'openocr.tools.data.native_size_dataset',
    'CMERWebDataSet': 'openocr.tools.data.cmer_web_dataset',
}

# 定义支持的 Sampler 类及其对应的模块路径
SAMPLER_MODULES = {
    'MultiScaleSampler': 'openocr.tools.data.multi_scale_sampler',
    'RatioSampler': 'openocr.tools.data.ratio_sampler',
    'NaSizeSampler': 'openocr.tools.data.native_size_sampler',
}
